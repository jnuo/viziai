...
High cholesterol sometimes traces back to a thyroid problem: [learn what your TSH level means](/en/blog/tsh-levels-thyroid-hormone-explained) — an underactive thyroid raises cholesterol. For the other core blood values, see our [complete blood count (CBC) guide](/en/blog/complete-blood-count-cbc-explained).
